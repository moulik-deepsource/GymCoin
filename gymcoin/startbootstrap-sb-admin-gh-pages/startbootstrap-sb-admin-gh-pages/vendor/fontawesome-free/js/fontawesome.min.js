  ...
  (pt.prototype = {
    ...
    then: function (t, e) {
      ...
      return (
        (!e && !t) ||
          this._handled ||
          ((this._handled = !0), this._state === $ && et && it(ht, this)),
        this._state === Z || this._state === $ ? it(ot, n) : this._then.push(n),
        n.then
      );
    },
    catch: function (t) {
      ...
      q =
        a.found && n.found
          ? ((y = (b = D).children),
            ...
            (S = k.width),
            (z = k.icon),
            (M = Mt({ transform: A, containerWidth: S, iconWidth: C })),
            (O = { tag: "rect", attributes: B({}, Ot, { fill: "white" }) }),
            (E = {
              tag: "g",
              ...
              children: [
                {
                  tag: "path",
                  attributes: B({}, N.attributes, M.path, { fill: "black" }),
                },
              ],
            }),
        ...
        (b +=
          (v = void 0 !== g && g) && k
            ...
            ? "translate(calc(-50% + "
                ...
                .concat(u.y / vt, "em)) ")
            : "translate(".concat(u.x / vt, "em, ").concat(u.y / vt, "em) ")),
        (b += "scale("
  ...
  function Kt(t) {
    return t.reduce(function (t, e) {
      ...
      if (Ut[e]) t.prefix = e;
        ...
        var a =
          "fa" === t.prefix ? Wt[n] || { prefix: null, iconName: null } : {};
        (t.iconName = a.iconName || n), (t.prefix = a.prefix || t.prefix);
      } else
        e !== V.replacementClass && 0 !== e.indexOf("fa-w-") && t.rest.push(e);
      return t;
    }, Vt());
  }
  function Gt(t, e, n) {
    ...
    return "string" == typeof t
      ...
      : "<"
          ...
          .concat(
            ...
            Object.keys(n || {})
              .reduce(function (t, e) {
                return t + "".concat(e, '="').concat(Nt(n[e]), '" ');
              }, "")
              .trim()),
            ">"
          )
      ...
      if (r && i && pe[i] && pe[i][r]) {
        ...
        return t(
          (n = {
            ...
            icon: {
              tag: "path",
              attributes: { fill: "currentColor", d: a.slice(4)[0] },
            },
          })
        );
      }
  ...
  function be(t) {
    ...
    return ~a.extra.classes.indexOf(P)
      ...
      : ((i = t),
        ...
        (u = e.extra),
        new gt(function (r, t) {
          gt.all([ge(o, s), ge(n.iconName, n.prefix)]).then(function (t) {
            var e = d(t, 2),
              n = e[0],
              a = e[1];
            r([
    ...
    return new gt(function (a, t) {
      ...
      if (r) {
        var o = n.getPropertyValue("content"),
          ...
          l = Bt(c, s),
          f = l;
        if (!l || (e && e.getAttribute(C) === c && e.getAttribute(N) === f))
          a();
        else {
              ...
              Object.keys(r).forEach(function (t) {
                (e.definitions[t] = B({}, e.definitions[t] || {}, r[t])),
                  (function t(e, a) {
                    ...
                    "function" != typeof q.hooks.addPack || r
                      ? (q.styles[e] = B({}, q.styles[e] || {}, i))
                      : q.hooks.addPack(e, i),
                      "fas" === e && t("fa", a);
                  })(t, r[t]),
                  Xt();
          ...
          return (
            ...
            (function (t) {
              ...
              extra: {
                attributes: c,
                styles: l,
                classes: ["".concat(V.familyPrefix, "-layers-counter")].concat(
                  m(i)
                ),
              },
            })
